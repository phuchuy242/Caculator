 ...
 * @author LENOVO
 */
public class frmDoDai extends javax.swing.JFrame {
   private static final Map<String, Double> conversionRates = new HashMap<>();
    
    static {
        conversionRates.put("Millimeter", 1.0);
        conversionRates.put("Centimeter", 10.0);
        conversionRates.put("Metters", 1000.0);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Millimeter", "Centimeter", "Metters", "Hectares", "Kilometers", "inches", "Feet" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Millimeter", "Centimeter", "Metters", "Hectares", "Kilometers", "inches", "Feet" }));
    ...
    try {
            ...
            if (conversionRates.containsKey(fromUnit) && conversionRates.containsKey(toUnit)) {
                double valueInMillimeters = inputValue * conversionRates.get(fromUnit);
                double convertedValue = valueInMillimeters / conversionRates.get(toUnit);
                txtResult1.setText(String.format("%s", convertedValue).replaceAll("\\.0+$", ""));
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDoDai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
